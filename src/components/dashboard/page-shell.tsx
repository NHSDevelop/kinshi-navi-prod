  ...
  return (
    <div className="mx-auto flex w-full max-w-6xl flex-col gap-6 pb-10">
      <section className="relative overflow-hidden rounded-2xl border border-main-200 bg-linear-to-br from-main-100/40 via-main-50/30 to-white p-5 shadow-xs md:p-6">
        ...
        <div className="absolute -bottom-16 left-8 h-40 w-40 rounded-full bg-main-300/10 blur-3xl" />
        <div className="absolute inset-x-0 top-0 h-px bg-linear-to-r from-transparent via-main-300/40 to-transparent" />
        <div className="relative flex flex-col gap-2.5">
          <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-main-700">
            Dashboard
          </p>
          <h1 className="text-xl font-bold tracking-tight text-main-950 md:text-2xl lg:text-3xl">
            {title}
          </h1>
          {description ? (
            <p className="max-w-2xl text-xs leading-relaxed text-main-800">
              {description}
            </p>
          ) : null}
        </div>
